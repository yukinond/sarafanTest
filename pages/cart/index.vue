...
<template>
  <div class="max-w-4xl mx-auto p-6">
    <h1
      class="text-3xl font-bold mb-8 text-gray-900 flex w-full justify-center"
    >
      Корзина
    </h1>
    ...
    <div v-if="hasItems" class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="col-span-2 space-y-6">
        <div
          ...
          :key="product.uuid"
          class="flex items-center bg-white p-5 rounded-lg shadow-md hover:shadow-lg transition"
        >
          <nuxt-img
            :src="product.image"
      ...
      <div
        class="col-span-1 bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition"
      >
